...
public class ACCService extends BluetoothLEClientService {
	...
	public static String ACC_VALUE_CHAR = BluetoothLENamespace
			.toUuid128StringFormat(0xffa3);// "0000fec5-0000-1000-8000-00805f9b34fb";
	...
	public void onWatcherValueChanged(
		...
		localIntent.putExtra("X", (float) decodedData[0]);
		localIntent.putExtra("Y", (float)1.0);
		localIntent.putExtra("Z", (float)1.0);
